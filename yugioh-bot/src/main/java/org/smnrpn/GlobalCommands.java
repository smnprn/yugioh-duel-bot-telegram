...
public class GlobalCommands extends TelegramLongPollingBot {
    ...
    public void sendHelpMessage(Long id) {
        String helpMessage = "<b>Use the button below if you experienced a bug!</b>" + LINE_BREAK +
                             ...
                             "/start - Shows a welcome message with links to the project's official page, GitHub and Ko-Fi." + LINE_BREAK +
                             "/links - Shows links to many useful resources with a brief description." + LINE_BREAK +
                             "/roll - Roll a die to choose who go first." + LINE_BREAK +
                             "/lifepoints - Starts a LP counter to use in your duels." + LINE_BREAK +
    ...
    public InlineKeyboardMarkup createStartInlineKeyboard() {
        ...
        projectPage.setUrl("https://pages.github.com/");
